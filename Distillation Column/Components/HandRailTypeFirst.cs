...
namespace DistillationColumn
{
    internal class HandRailTypeFirst
    {
        ...
        public void CreateSideHandRailAtExtension(ContourPoint sPoint,double extensionlength,string location,int side)
        {
            ...
            //midrail           
            Beam b1=_tModel.CreateBeam(sPoint,ePoint,MidRailProfile, "IS2062","9",_global.Position,"midrail");
            ...
            Beam b2=_tModel.CreateBeam(sPoint, ePoint,TopRailProfile, "IS2062", "9", _global.Position, "toprail");
            point1 = _tModel.ShiftHorizontallyRad(sPoint, 6, side);
            ...
            if(location=="start")
            {
                ...
                _global.Position.Depth = Tekla.Structures.Model.Position.DepthEnum.BEHIND;
                Beam b3=_tModel.CreateBeam(sPoint, ePoint, VerticalPostProfile, "IS2062", "9", _global.Position, "verticalPost");
            ...
            else
            {
                ...
                Beam b4=_tModel.CreateBeam(sPoint, ePoint, VerticalPostProfile, "IS2062", "9", _global.Position, "verticalPost");
